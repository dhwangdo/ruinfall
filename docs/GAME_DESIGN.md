...
- 안전 지역이 아닌 곳에서는 덱의 카드를 인벤토리나 바닥으로 꺼낼 수 없다.
- 안전 지역이 아닌 곳에서도 덱 카드를 휴지통으로 드래그해 완전히 제거할 수 있다.
- 안전 지역에서는 골드 비용 없이 덱과 인벤토리 사이에서 카드를 자유롭게 옮길 수 있다.
- 취소 전까지 휴지통으로 제거한 카드는 편집 취소로 되돌릴 수 있다.
- 카드 목록에 마우스를 올리면 포인터 오른쪽 아래에 카드 미리보기가 표시된다.
- 취소는 편집 전 상태를 복구한다.
